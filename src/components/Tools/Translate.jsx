...
const Translate = ({ toggleLanguage, isEnglish }) => {
  return (
    <div onClick={toggleLanguage} className="Translate__configure">
      
      <svg className="Translate_btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
